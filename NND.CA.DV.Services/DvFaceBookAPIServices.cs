...
{
    public class DvFaceBookAPIServices<T> : FlatService<T>, IDvEntityService<T> where T : DVModelViewModel<DVModel>, new()
    {
        public DvFaceBookAPIServices(IUnityContainer basemodelContext) : base(basemodelContext)
        {
        }
